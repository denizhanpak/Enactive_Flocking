turtles-own [
  ...
  parenting-contribution ;; dynamic value which when summed should allow for
]
...
to make-baby ;; turtle procedure
  if count flockmates = parent-count [ hatch 1 ]
end

;;; CRASH
to crash ;; turtle procedure
  if [ pcolor ] of patch-here  = 65 [ die ]
  boom
end

to boom ;; turtle procedure
  ask flockmates [ turn-away heading max-separate-turn ]
end
