turtles-own [
  ...
  contribution-parameter ;; Action potential to generate new boid
]
...
to flock  ;; turtle procedure
  find-flockmates
  set contribution-parameter (contribution-parameter + 1)
  if any? flockmates
...
to make-baby ;; turtle procedure
  if sum [contribution-parameter] of flockmates > birth-threshold [ hatch 1 [ fd 1 lt random 360] ]
  ask flockmates [ reset-contribution ]
end

to reset-contribution
  set contribution-parameter 0
end

to boom ;; turtle procedure
  let angle heading
  ask flockmates [ turn-away angle max-sense-turn ]
end
